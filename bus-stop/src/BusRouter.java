...
public class BusRouter {
	...
	/* startNewRoute: Inicia um novo cálculo de Rota, onde:
	 ...
	 4 - a partir da distância, são obtidas duas listas de Trips: as mais próximas das paradas de origem/destino
	...
	*/
	public void startNewRoute() {
		...
		System.out.println("Linha mais próxima da origem: ");
		System.out.println(closestOriginTrip.getRoute().getShortName());
		
		System.out.println("Linha mais próxima do destino: ");
		System.out.println(closestDestinyTrip.getRoute().getShortName());
	...
	/* askUserToCreateCoordinate: Pede ao usuário que informe uma latitude e uma longitude, 
	   a fim de criar uma coordenada. Ao final da função, retorna-se a coordenada.
	*/
