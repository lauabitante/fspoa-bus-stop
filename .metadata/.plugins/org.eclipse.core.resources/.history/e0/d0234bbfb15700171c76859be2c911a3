...
public class Main {
	...
	public static void main(String[] args) throws FileNotFoundException {
		...
		Map<String,Stop> stops =
				GTFSReader.loadStops("bin/data/stops.txt");
		System.out.println("Reading routes.");
		Map<String,Route> routes =
				GTFSReader.loadRoutes("bin/data/routes.txt");
		System.out.println("Reading shapes.");
		Map<String,Shape> shapes =
				GTFSReader.loadShapes("bin/data/shapes.txt");
		System.out.println("Reading calendar.");
		Map<String,Service> services =
				GTFSReader.loadServices("bin/data/calendar.txt");
		System.out.println("Reading trips.");
		Map<String,Trip> trips =
				GTFSReader.loadTrips("bin/data/trips.txt",routes,services,shapes);
